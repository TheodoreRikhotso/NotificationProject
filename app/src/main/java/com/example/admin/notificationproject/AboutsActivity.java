...
public class AboutsActivity extends AppCompatActivity {
    ...
    private EditText txtImageName,txtdescription,descriptions;
    private Uri imgUri;
        ...
        if (imgUri != null) {
            ...
            ref.putFile(imgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    ImageUpload imageUpload = new ImageUpload(txtImageName.getText().toString(), taskSnapshot.getDownloadUrl().toString(),txtdescription.getText().toString(),descriptions.getText().toString());
